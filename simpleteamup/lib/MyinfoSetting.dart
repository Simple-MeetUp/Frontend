...
class MyinfoSetting extends StatefulWidget {
  @override
  _MyinfoSetting createState() => _MyinfoSetting();
}

class _MyinfoSetting extends State<MyinfoSetting> {
  // API를 통해 변환
  String myName  = '홍길동';
  ...
  TextEditingController nicknameEditController = TextEditingController(text: "Festive Leave");
              ...
              IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      else nicknameEditisEnable = true;
                    });
                  })
            ],
          ),
